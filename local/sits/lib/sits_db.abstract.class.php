...
abstract class sits_db implements i_sits_db {
    ...
    */
    ...
    public function insert_agreed_grade( $student,$grade,$cohort ){
        ...
        /*Insert request from Amy Cavanagh to additional fields - Hittesh */
		$this->smr_rslt = $grade->smr_rslt;
		$this->smr_cred = $grade->smr_cred;
		$this->smr_coma = $grade->smr_coma;
		$this->sas_coma = $grade->sas_coma;
		$this->smr_proc = $grade->smr_proc;
 ...
 */
    public function update_agreed_grade( $student,$grade,$cohort ){
        ...
        $this->map_code = $cohort->map_code;
        $this->mab_seq = $cohort->mab_seq;
        /*Hittesh - Update request from Amy Cavanagh to additional fields*/
		$this->smr_rslt = $grade->smr_rslt;
		$this->smr_cred = $grade->smr_cred;
		$this->smr_coma = $grade->smr_coma;
		$this->sas_coma = $grade->sas_coma;
 ...
 * Fetch survey data for a given student
 * Hittesh Ahuja - University of Bath
 */
    public function get_survey_stats_student($student)
    {
	     $this->bucs_id = $student->username;
	     if(!oci_execute($this->get_current_survey_stats_student_stm))
	     {
	          return false;
	     }
		$results = array();
    ...
    */
    ...
    /**
    * Online Unit Evaluation
     * fetch survey details for a given user
     * Hittesh Ahuja
     */
