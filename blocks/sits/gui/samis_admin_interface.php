        ...
        <div id = "container">
            <div id = "period_container" class="admin_box">
                ...
                <div class = "admin_instruction">
                    ...
                    This affects only Moodle, it makes no changes to SITS.  For the SAMIS-defined slots, go to <a href="http://www.bath.ac.uk/catalogues/information/staff/period-slot-dates" target="_blank">SAMIS Period Slot Dates for the <?php echo  date('Y')."/".(date('y') + 1) ?> Academic Session</a>.</p>
